...
<?php 
    function cruella ($price) {
        $arg_1 = ceil ($price);
        
        if ($price > 1000) {
            $arg_2 = number_format ($arg_1, 0, ' ', ' '); 
            $arg_2 .= "  ₽";
          }
        ...
        <?php foreach ($double as $key => $val):?>
            <li class="lots__item lot">
                ...
                <div class="lot__info">
                    ...
                    <h3 class="$var['name']"><a class="text-link" href="lot.html"></a></h3>
                    <div class="lot__state">
                        <div class="lot__rate">
                            <span class="lot__amount">Стартовая цена</span>
                            <span class= cruella (var ['price'])><b class="rub"></b></span>
                        </div>
